...
public class Shipment extends AbstractJob {
    ...
    public static class Builder {
        ...
        public Builder setTaipingGroup(int taipingGroup) {
            this.taipingGroup = taipingGroup;
            return this;
        }
    ...
    private final int taipingGroup;
    ...
    Shipment(Builder builder) {
        ...
        this.taipingGroup = builder.taipingGroup;
